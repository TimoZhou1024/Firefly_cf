...
description: 解决Windows Hello人脸识别无法使用的问题，通过重置Windows Biometric Service和删除数据库文件实现修复。
image: https://www.loliapi.com/acg?id=20251109
tags: [Windows Hello,人脸识别,PIN]
category: debug
draft: false
---
